...
def main():
    ...
    pygame.display.set_caption("リズムエディター Final (v5)")
    ...
    btn_bpm_minus = Button("-", (960, 40), font, padding=5); btn_bpm_plus = Button("+", (1070, 40), font, padding=5)
    ...
    while True:
        ...
        bpm_text = font.render(f"BPM: {bpm:.0f}", True, C_BLACK); screen.blit(bpm_text, bpm_text.get_rect(center=(1020, 40)))
